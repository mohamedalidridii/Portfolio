  ...
  return (
    <Box align="center" opacity={0.7} fontSize="sm" position="relative">
                ...
                <Flex gap={12} align="center" justify="center" >
                    ...
                    <IoLogoLinkedin color={useColorModeValue('black', 'white')} size={"1.8rem"}  style={{cursor:'pointer'}}/>
                        </NextLink>  
                        <NextLink href="https://github.com/mohamedalidridii" key={"gh"} >
                    <IoLogoGithub color={useColorModeValue('black', 'white')} size={"1.8rem"}  style={{cursor:'pointer'}}/>
                        </NextLink>                              
                </Flex>
                <Flex gap={12}  align="center" justify="center" mt={"3vh"} mb={"1vh"}>
                        <NextLink href="https://www.facebook.com/daly.19435/" key={"fa"} >
                    <IoLogoFacebook color={useColorModeValue('black', 'white')} size={"1.8rem"}  style={{cursor:'pointer'}}/>
                        </NextLink>
                        <NextLink href="https://twitter.com/daly4111" key={"tw"} >
                    <IoLogoTwitter color={useColorModeValue('black', 'white')} size={"1.8rem"}  style={{cursor:'pointer'}}/>
                        </NextLink>
                        <NextLink href="https://www.instagram.com/medaly.dridi/" key={"in"} >
                    <IoLogoInstagram color={useColorModeValue('black', 'white')} size={"1.8rem"}  style={{cursor:'pointer'}}/>
                        </NextLink>
                        <NextLink href="https://www.behance.net/DALY3DESIGN" key={"li"} >
                    <IoLogoBehance color={useColorModeValue('black', 'white')} size={"1.8rem"}  style={{cursor:'pointer'}}/>
                        </NextLink>
                </Flex>
                </Box>
